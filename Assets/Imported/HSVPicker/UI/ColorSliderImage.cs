...
namespace HSVPicker
{
    ...
    {
                // Establecer el slider rojo en 0 si el tipo de color es R
                if (picker != null && type == ColorValues.R)
                {
                    picker.AssignColor(ColorValues.R, 0);
                }
                if (picker != null && type == ColorValues.G)
                {
                    picker.AssignColor(ColorValues.G, 0);
                }

if (picker != null && type == ColorValues.B)
                {
                    picker.AssignColor(ColorValues.B, 0);
                }
